...
<div class="container">
    <form action="/p/{{ $post-> id }}" enctype="multipart/form-data" method="post">
        ...
        <div class="form-group row">
            ...
            <input type="checkbox" class="" name="online" id="online" {{ old('online') ??  $post->online == '1' ? 'checked': ''  }}>
        ...
        <div class="form-group row">
            <span class="pr-3"><button class="btn btn-primary" type="submit"> Update Post </button></span>
            <span class="pr-3"><a class="btn btn-secondary" href="/profile/{{ $post->user_id }}"> Cancel </a></span>
        </div>
